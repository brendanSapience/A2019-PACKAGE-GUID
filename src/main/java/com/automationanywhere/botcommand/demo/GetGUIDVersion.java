 ...
 */
@BotCommand
@CommandPkg(label="Get GUID Version", name="get GUID version", description="Get GUID Version", icon="pkg.svg",
		node_label="Get GUID Version",
		return_type=STRING, return_label="Assign the output to variable", return_required=true)

public class GetGUIDVersion {
			...
			)
	{
		...
		String v = String.valueOf(uuid.version());
